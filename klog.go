...
func (l *FiledLogger) WithFloat64Field(key string, value float64) Interface {
	return l.WithFields(Fields{key: fmt.Sprintf("%f", value)})
}
...
func (l *FiledLogger) WithInt64Field(key string, value int64) Interface {
	return l.WithFields(Fields{key: strconv.FormatInt(value, 10)})
}
...
func (l *FiledLogger) WithIntField(key string, value int) Interface {
	return l.WithFields(Fields{key: strconv.Itoa(value)})
}
...
func (l *FiledLogger) WithBoolField(key string, value bool) Interface {
	return l.WithFields(Fields{key: strconv.FormatBool(value)})
}
...
func (l *FiledLogger) WithDurationField(key string, value time.Duration) Interface {
	return l.WithFields(Fields{key: value.String()})
}
...
func ParseTimeEncoder(f string) TimeEncoder {
...
func StrField(key, value string) func(f Fields) {
